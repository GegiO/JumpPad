...
public class Reference {
	...
	public static final String CLIENT_PROXY_CLASS = "archduke.JumpPads.proxy.ClientProxy";
	public static final String SERVER_PROXY_CLASS = "archduke.JumpPads.proxy.CommonProxy";
